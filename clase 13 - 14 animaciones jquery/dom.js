...
$("#buttonLog").on("mouseleave", function () {
  $(".log").hide();
});

$("#buttonLog").on("mouseenter", function () {
  $(".log").show();
});
...
function singup(e) {
  ...
  if (nombre == "nombre" && contrasena == pass) {
    $("span").text("Validando datos...").show();
    console.log("Usuario: " + nombre.val() + apellido.val());
